...
import AIHuman from "../../../../assets/aihuman.png";
...
const AIResumeBuilder = () => {
  return (
    <section
      id="aiResume"
      className="mt-20 lg:h-[360px] bg-gradient-to-r from-[#99DAF4] to-[#ACA2EF] px-6 md:px-12 rounded-[70px] rounded-br-none rounded-tl-none flex flex-col lg:flex-row items-center justify-between relative overflow-hidden"
    >
      <div className="p-5 mb-10 md:mb-0 relative z-10">
        ...
        <button className="bg-black text-white px-6 py-3 rounded-full flex items-center gap-3 hover:bg-blue-700 transition">
          ...
          <div className="bg-white w-8 h-8 rounded-full flex items-center justify-center">
            <img src={ArrSubnav} alt="arrow icon" className="w-4 h-4" />
          </div>
        </button>
      </div>
